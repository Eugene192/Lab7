...
set CLASSPATH=%APP_HOME%\lib\client.jar;%APP_HOME%\lib\common-1.0-SNAPSHOT.jar;%APP_HOME%\lib\jsch-0.1.44-1.jar;%APP_HOME%\lib\commons-cli-1.7.0.jar;%APP_HOME%\lib\dotenv-java-3.0.0.jar


@rem Execute client
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CLIENT_OPTS%  -classpath "%CLASSPATH%" org.eugene.client.Main %*
